...
public class Subtract4ParameterizedTest {
	...
	public static void BeforeClass() {System.out.println ("Come on, Baby! Subtract (-) 4 params.");}
	...
	public static Collection<Double[]> subtractNumbers() {
		return Arrays.asList(new Double[][] {
			{ 46.0, 54.0, 2.0, 3.0, 3.0 },  // { 0.5, 1.0, 2.0 }, 
			{ 27.0, 36.0, 3.0, 3.0, 3.0 },  // { 0.66, 2.0, 3.0 }, 
			{ 15.0, 27.0, 3.0, 6.0, 3.0 },  // { 0.75, 3.0, 4.0 }, 
			{ 48.5, 59.0, 2.5, 3.0, 5.0 },  // { 0.8, 4.0, 5.0 },
		});}
	...
	@Test(timeout = 1000) // @Ignore
		...
		assertEquals("Not correct", Calculator.subtract(first, second, thrid, fourth), expected, 0.09);
				}
			}