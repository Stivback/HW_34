...
public class Subtract2ParameterizedTest {
	...
	public static void BeforeClass() {System.out.println ("Come on, Baby! Subtract (-) 2 params.");}
	...
	public static Collection<Double[]> subtractNumbers() {
		return Arrays.asList(new Double[][] {
			{ 3.0, 5.0, 2.0 },  // { 0.5, 1.0, 2.0 }, 
			{ 0.0, 3.0, 3.0 },  // { 0.66, 2.0, 3.0 }, 
			{ 4.0, 7.0, 3.0 },  // { 0.75, 3.0, 4.0 }, 
			{ 2.5, 5.0, 2.5 },  // { 0.8, 4.0, 5.0 },
		});}
