...
public class Multiply2ParameterizedTest {
	...
	public static void BeforeClass() {System.out.println ("Come on, Baby! Multiply (*) 2 params.");}
	...
	public static Collection<Double[]> multiplyNumbers() {
		return Arrays.asList(new Double[][] {
			{ 6.0, 3.0, 2.0 },  // { 0.5, 1.0, 2.0 }, 
			{ 9.0, 3.0, 3.0 },  // { 0.66, 2.0, 3.0 }, 
			{ 8.0, 2.0, 4.0 },  // { 0.75, 3.0, 4.0 }, 
			{ 5.0, 2.0, 2.5 },  // { 0.8, 4.0, 5.0 },
		});}
